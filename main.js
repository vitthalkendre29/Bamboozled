...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function createFile() {
        ...
        let elapsedTime = 300 - timeLeft; // Convert back to time elapsed
        let minutes = Math.floor(elapsedTime / 60);
        let seconds = elapsedTime % 60;
        let timestamp = `File downloaded at ${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')} by xyz.`;
